    ...
    db.DataCatalog.findAll({
        ...
        if(result.length > 0){
            ...
            db.DataCatalog.create({
                ...
                console.log(result);
                let jobID = `JOB_${request_data.source_abbrv}_${request_data.target_abbrv}_${result.entry_id}`;
                ...
                db.DataCatalog.update({
                    ...
                    db.Parameters.create({
                        ...
                        SourceParameter: request_data.source_parameter,
                        SourceQuery: request_data.source_query,
                        TargetType: request_data.target_type,
                        TargetParameter: request_data.target_parameter,
                        ...
                        let frameFinal = {};
                        frameFinal['entry_id'] = result.entry_id;
                        frameFinal['parameters'] = JSON.parse(JSON.stringify(parametersRes));

                        res.status(200).json({message: 'Successful', data: JSON.parse(JSON.stringify(data)) });
